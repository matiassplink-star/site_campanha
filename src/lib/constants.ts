...
export const SITE_CONFIG = {
  ...
  title: "Brivaldo Marques — Vereador de Maceió",
  description:
    "Brivaldo Marques, Vereador de Maceió e pré-candidato a Deputado Estadual. Saúde e Juventude como prioridades para Alagoas.",
